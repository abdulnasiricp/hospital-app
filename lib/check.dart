...
class Insurance_Validity extends StatefulWidget {
  ...
  final String selectedInsurancetypeId;
  const Insurance_Validity({
    ...
    required this.selectedInsurancetypename, // Pass these parameters
    required this.selectedInsurancetypeId,
  }) : super(key: key);
  @override
...
class _Insurance_ValidityState extends State<Insurance_Validity> {
  ...
  Future<void> fetchInsuranceDetails() async {
    ...
    final body = jsonEncode({
      "insurance_type": selectedInsurancetypename,
