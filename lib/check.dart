...
//           // Access department list, genderList, and marital_status
//           final departmentList = data?['department'];
//           final genderList = data?['genderList'];
//           final maritalStatus = data?['marital_status'];

//           return Column(
//             children: [
//               // Display the department list in a BottomSheet
//               ElevatedButton(
//                 onPressed: () {
...
//                     builder: (context) {
//                       return ListView(
//                         children: departmentList.map<Widget>((dept) {
//                           return ListTile(
//                             title: Text(dept['name']),
//                             onTap: () {
//                               // Handle the department selection here
...
//               // Display genderList and maritalStatus in TextFormFields
//               DropdownButtonFormField<String?>(
//                 value: null, // Set the selected value
//                 onChanged: (value) {
//                   // Handle gender selection here
//                 },
//                 items: genderList.keys.map((key) {
//                   return DropdownMenuItem<String?>(
//                     value: key,
//                     child: Text(genderList[key]),
//                   );
//                 }).toList(),
//               ),
...
//                 value: null, // Set the selected value
//                 onChanged: (value) {
//                   // Handle marital status selection here
//                 },
//                 items: maritalStatus.keys.map((key) {
//                   return DropdownMenuItem<String?>(
//                     value: key,
//                     child: Text(maritalStatus[key]),
//                   );
//                 }).toList(),
//               ),
//             ],
