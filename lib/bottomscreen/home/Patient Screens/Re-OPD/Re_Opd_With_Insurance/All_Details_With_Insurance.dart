...
class All_Details_With_Insurance extends StatefulWidget {
  ...
  const All_Details_With_Insurance({
    Key? key,
  ...
  @override
  State<All_Details_With_Insurance> createState() =>
      _doctor_book_iinsurance_detalsState();
}

class _doctor_book_iinsurance_detalsState
    extends State<All_Details_With_Insurance> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        Get.to(() => Reopd_Successfull_Insurance(
                              ...
                              Ticket_TypeId: widget.Ticket_TypeId,
                            ));
                      },
                      child: Container(
                        width: width / 1,
