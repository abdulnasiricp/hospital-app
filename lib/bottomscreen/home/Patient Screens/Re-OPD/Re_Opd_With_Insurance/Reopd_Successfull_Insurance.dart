...
class Reopd_Successfull_Insurance extends StatefulWidget {
  final String name;
  ...
  final String Ticket_TypeId;

  const Reopd_Successfull_Insurance({
    Key? key,
    required this.name,
    ...
    required this.Ticket_TypeId,
  }) : super(key: key);

  @override
  State<Reopd_Successfull_Insurance> createState() =>
      _Reopd_Successfull_InsuranceState();
}

class _Reopd_Successfull_InsuranceState
    extends State<Reopd_Successfull_Insurance> {
  ...
  Future<void> makePostRequest() async {
    ...
    final Map<String, String> body = {
      ...
      "is_emergency": widget.Ticket_TypeId,
      "address":
