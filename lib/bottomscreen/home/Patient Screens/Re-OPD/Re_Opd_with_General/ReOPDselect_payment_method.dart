// ignore_for_file: non_constant_identifier_names, sized_box_for_whitespace, avoid_unnecessary_containers, file_names, deprecated_member_use
...
class ReOPdCheckSelectPaymentMethod extends StatefulWidget {
  ...
  const ReOPdCheckSelectPaymentMethod({
    Key? key,
...
class _SelectPaymentMethodState extends State<ReOPdCheckSelectPaymentMethod> {
  String refId = '';
  String hasError = '';
