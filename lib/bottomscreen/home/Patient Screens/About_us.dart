                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Text('Civil service Hospital',style: TextStyle(fontWeight: FontWeight.bold),),
                                const Text("प्रादेशिक अस्पताल सिराहा \nसिरहा , नेपाल"),
                                    ...
                                    child: const Row(
                                      children: [
                                        Padding(
                                          ...
                                          child: Text('   200 \n General',style: TextStyle(fontSize: 10),),
                                        ),
                                         Padding(
                                          padding: EdgeInsets.all(8.0),
                                          child: Text('     20 \n ICU/CCU',style: TextStyle(fontSize: 10),),
                                        ), Padding(
                                          padding: EdgeInsets.all(8.0),
                                          child: Text('     20 \n Emergency',style: TextStyle(fontSize: 10),),
                                        )
                                      ],
                                    ),
                                  ),
                      ...
                      Padding(
                        ...
                        child: Container(
                          child: const Row(children: [
                            Icon(Icons.phone,color: Colors.blue),SizedBox(width: 10,), Text('01-410235000')
                          ],),
                        ),
                      ),
                        Padding(
                          ...
                          child: Container(
                          child: const Row(children: [
                            Icon(Icons.location_city,color: Colors.blue,),SizedBox(width: 10,),Text('View Location')
                          ],),
                                              ),
                        ),
                    ],
