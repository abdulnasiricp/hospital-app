...
class Dietreport extends StatefulWidget {
  const Dietreport({Key? key}) : super(key: key);

  @override
  State<Dietreport> createState() => _DietreportState();
}

class _DietreportState extends State<Dietreport> {
...
// get Patinent Detials
  ...
  Future<void> fetchMedicationreport() async {
    ...
    if (response.statusCode == 200) {
      ...
      final MedicationreportList = jsonResponse['diet_report'] as List<dynamic>;
                        ...
                        child: ListTile(
                          ...
                          subtitle: Column(
                            ...
                            children: [
                              ...
                              Text(
                                  'Diet Name: ${MedicationItem["diet"] ?? 'N/A'}'),
                            ],
                          ),
                        ),
                      );
