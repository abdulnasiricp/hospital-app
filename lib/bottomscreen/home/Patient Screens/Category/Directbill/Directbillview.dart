...
class Directbillview extends StatefulWidget {
  final String id;
  final String bill_pdf;
  const Directbillview({
    Key? key,
    required this.id,
    required this.bill_pdf,
  }) : super(key: key);

  @override
  State<Directbillview> createState() => _DirectbillviewState();
}

class _DirectbillviewState extends State<Directbillview> {
  double? _progress;
  String PatientId = '';
            ...
            onPressed: () async {
              ...
              if (status.isGranted) {
                FileDownloader.downloadFile(
                  name: 'Tez_Health_Care-Direct-Bill-$PatientId.pdf',
                  url: widget.bill_pdf,
