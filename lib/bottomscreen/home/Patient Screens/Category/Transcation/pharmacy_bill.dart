...
class PharmacyBill extends StatefulWidget {
  const PharmacyBill({Key? key}) : super(key: key);

  @override
  State<PharmacyBill> createState() => _PharmacyBillState();
}

class _PharmacyBillState extends State<PharmacyBill> {
  String username = '';
  late String patient = '';
  LoadData() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        setState(() {
          ...
          DoneListData = responseData?['pharmacy_bill'];
          print(DoneListData);
          isLoading = false;
        });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Pharmacy Bill'),
        centerTitle: true,
