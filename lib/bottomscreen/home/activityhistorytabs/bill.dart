...
class ActivityBill extends StatefulWidget {
  const ActivityBill({Key? key}) : super(key: key);

  @override
  State<ActivityBill> createState() => _ActivityBillState();
}

class _ActivityBillState extends State<ActivityBill> {
